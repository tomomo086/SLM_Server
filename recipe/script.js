...
- ユーザーが料理名を入力したら、**必ずsearch_recipes関数を実行**してください
  - 例：「チンジャオロース」→ search_recipes(keyword="チンジャオロース")
  - 例：「カレー」→ search_recipes(keyword="カレー")
  - 例：「から揚げ」→ search_recipes(keyword="から揚げ")
- ユーザーが材料について質問したら、**必ず**適切な関数を実行してください
